    ...
    with sqlite3.connect(DATABASE_PATH) as conn:
        ...
        if cursor.fetchone()[0] == 0: 
            cursor.executemany("""
                ...
                VALUES (?, ?, ?)
            """, [
            ("Abdosami", generate_password_hash("B2110"), 1500.0),
            ("7amada", generate_password_hash("M2004"), 1000.0),
            ("Ta7oon", generate_password_hash("O2004"), 2000.0),
            ("Amora", generate_password_hash("A6202"), 2500.0)
            ])
        conn.commit()
